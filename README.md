...
- Внедрена технология развертывания (Docker, Docker Compose) для веб-сервиса на любом устройстве (другом компьютере, удаленном сервере и т.д.)
...
## Как запустить
Для развертывания приложение необходимо наличие установленного [Docker](https://www.docker.com/products/docker-desktop/) на рабочей машине.
...
- Оптимизация используемых для развертывания технологий и кода сервиса
- Внедрение SOTA-моделей (например TabPFN) для решения задачи прогнозирования дефолта
- Внедрение LLM-агента для анализа данных клиента
- Улучшение UI/UX составляющей сервиса и дизайна README